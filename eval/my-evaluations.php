  ...
  <div class='card mb-4'>
    <div class='card-body'>
      <div class='row align-items-center'>
        <div class='col'>
          <small class='text-muted-show mb-1'>$db_course</small>
          <hr>
          <p class='card-text'>$db_started</p>";

          if($db_status == "STARTED"){
          echo "<button class='take-quiz-button' data-toggle='modal' data-target='#quizModal$db_id'>Take Action</button>";
        ...
        <div class='col-4 text-right'>
           ...
           <input type='hidden' name='coursetitle' value='$db_course'> 
           ...
           <h5 class='modal-title text-muted'>View Certificate</h5> 
           <button type='button' class='close' data-dismiss='modal'>&times;</button> 
           </div> 
           ...
           <span class='ml-1 text-muted'>You can view, print and download your certificate by clicking the Print Button</span>
           
           <div class='d-flex justify-content-center mt-4'> 
           <button type='submit' name='print' class='btn btn-primary btn-lg mr-1'>Print</button>
           </div> 
    ...
    if(in_array($ext, $allowedTypes)){
        if(move_uploaded_file($tempName, $targetPath)){
            $query = "UPDATE evaluation SET status='FOR VERIFICATION', course_file ='$fileName' WHERE employee_name ='$fullname' AND course_title = '$course'";
        ...
        if(isset($_POST['print'])) {
              ...
              $WOW = $_SESSION['fullname'];

              $wiw = $_SESSION['course'];

              echo "<script language='javascript'>alert('Generating your course certificate. Please click OK.')</script>";
              echo "<script>window.location.href='generate-pdf.php';</script>";
        }
