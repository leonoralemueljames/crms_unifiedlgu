...
// Itakda ang base URL batay sa kapaligiran
if ($_SERVER['SERVER_NAME'] == 'localhost') {
    $baseUrl = "http://localhost/reset/reset-password.php";
} else {
    $baseUrl = "http://crms.unifiedlgu.com/reset/reset-password.php";
}
...
if ($stmt->affected_rows > 0) {
    ...
    <body>
        <div class="container">
            ...
            <a style="color: white;" class="button" href="{$baseUrl}?token={$token}">Reset Your Password</a>
