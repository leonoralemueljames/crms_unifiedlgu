  ...
  <div class="avatar-img rounded-circle avatar-initials-min text-center position-relative">
      ...
      <aside class="sidebar-left border-right bg-white " id="leftSidebar" data-simplebar>
        ...
        <nav class="vertnav navbar-side navbar-light">
          ...
          <p class="text-muted-nav nav-heading mt-4 mb-1">
          <span style="font-size: 10.5px; font-weight: bold; font-family: 'Inter', sans-serif;">ACCOUNT MANAGEMENT</span>
          </p>
...
<button type="button" class="btn btn-secondary btn-block" onclick="clearAllNotifications()">Clear All</button>
      ...
      <div class="col">
      <h2 class="h5 page-title">Portal Account List</h2>
</div>

<?php


$result = $conn->query("SELECT COUNT(*) as total_users FROM admin_accounts");
...
<div class="col-md-4">
  <div class="card mb-4">
    <div class="card-body">
      <div class="row align-items-center">
        <div class="col">
          <small class="text-muted-show mb-1">Pending Accounts</small>
          <h3 class="card-title" style="font-size:32px;"><?php
echo$blocked_users;
?></h3>
        ...
        <div class="col-4 text-right">
          <span class="sparkline"><img src="../../assets/images/clock.png" width="50"></span>
        </div>
...
class="fe fe-user-plus fe-15 mr-2"></span>Create Account</button>
...
if ($result->num_rows > 0) {
  while($row = $result->fetch_assoc()) {
    ...
    if (isset($row["created_at"])) {
      echo "<td>" . substr($row["role"], 0, 20) . "</td>";
    } else {
      echo "<td></td>";
    }
    echo "&nbsp &nbsp";
