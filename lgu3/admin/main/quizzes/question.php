...
<html lang="en">
  <head>
    ...
    <title>Employee Points - CRMS PORTAL</title>
...
?>
      ...
      <aside class="sidebar-left border-right bg-white " id="leftSidebar" data-simplebar>
        ...
        <nav class="vertnav navbar-side navbar-light">
          ...
          <ul class="navbar-nav flex-fill w-100 mb-2">
            <li class="nav-item w-100">
              <a class="nav-link" href="../../../admin/account_mgmt/manager-account">
              <i class="fa-solid fa-people-roof"></i>
                <span class="ml-3 item-text">Manager Accounts</span>
              </a>
            </li>
          </ul>
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $quiz_id = $_GET['quiz_id']; // Assuming quiz_id is passed as a query parameter
    ...
    if ($stmt->execute()) {
        // Redirect back to the quiz page or wherever you want
        header("Location: /path/to/your/quiz/page.php?quiz_id=" . $quiz_id);
...
?>
        ...
        <div class="col">
    <h2 class="h5 page-title">Question List</h2>
</div>
