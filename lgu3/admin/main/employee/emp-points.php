...
<button type="button" class="btn btn-secondary btn-block" onclick="clearAllNotifications()">Clear All</button>
        ...
        <div class="col">
    <h2 class="h5 page-title">Employee Points</h2>
</div>

<div class="container-fluid">
    <div class="col-md-12 alert alert-success">Points may be used to quantify how well employees comply with training requirements, policies, and procedures.</div>
