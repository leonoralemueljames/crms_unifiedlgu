...
<html lang="en">
  <head>
    ...
    <title>Ethics and Integrity in Public Service - CRMS</title>
    ...
    ?>
      ...
      <div class="col">
        <?php
             ...
             echo "<h2 class='h5 page-title'>Ethics and Integrity in Public Service</h2>";
...
$date = date("F m, Y h:i a");
       ...
       $retrieve_query = mysqli_query($conn, "SELECT * FROM evaluation WHERE employee_name = '$fullname'
        AND course_title = 'Ethics and Integrity in Public Service' ");
