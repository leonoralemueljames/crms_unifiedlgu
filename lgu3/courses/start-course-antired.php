...
<html lang="en">
  <head>
    ...
    <title>Anti-Red Tape Act Compliance for Barangay Employees - CRMS</title>
    ...
    ?>
      ...
      <div class="col">
        <?php
             ...
             echo "<h2 class='h5 page-title'>Anti-Red Tape Act Compliance for Barangay Employees</h2>";
...
$coursename = "Anti-Red Tape Act Compliance for Barangay Employees";
...
$date = date("F m, Y h:i a");
       ...
       $retrieve_query = mysqli_query($conn, "SELECT * FROM evaluation WHERE employee_name = '$fullname'
        AND course_title='Anti-Red Tape Act Compliance for Barangay Employees'");
