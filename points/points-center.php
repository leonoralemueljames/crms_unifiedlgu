...
<div class="col-md-4">
  <div class="card mb-4">
    <div class="card-body">
      <div class="row align-items-center">
        <div class="col">
          <small class="text-muted-show mb-1">View Incentives</small>
          <h3 class="card-title mb-1">10</h3>
...
<div id="getVoucher" class='modal fade' role='dialog'> 
           ...
           <div class='modal-content'> 
           <div class='modal-header'> 
           <h5 class='modal-title text-muted'>Incentives List</h5> 
           <button type='button' class='close' data-dismiss='modal'>&times;</button> 
           </div> 
           <div class='modal-body text-center p-10'> 
           <p class='font-weight-bold mb-4'>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <th scope="row">Performance-Based Leave Incentives<br/>
                      <span class="badge badge-light h5-small">Granting additional 1 day leave</span>
                     
                    </th>

                    <th scope="row">
                    <span><img src="../assets/images/points.png" width="15"></span>
                    <span class="badge h5-small">2000 points</span>           
                   </th>

                    <td class="h5-small"><a href=""><p class="large mb-1">
                      <span data-toggle="modal" data-target="#getVoucher" class="badge alert-info " >20 claims left</span></p></a></td>
                    <td></td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <th scope="row">Goods and Groceries<br/>
                      <span class="badge badge-light h5-small">50kg sack of rice</span>
                     
                    </th>

                    <th scope="row">
                    <span><img src="../assets/images/points.png" width="15"></span>
                    <span class="badge h5-small">5000 points</span>           
                   </th>

                    <td class="h5-small"><a href=""><p class="large mb-1">
                      <span data-toggle="modal" data-target="#getVoucher" class="badge alert-info " >17 claims left</span></p></a></td>
                    <td></td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <th scope="row">Goods and Groceries<br/>
                      <span class="badge badge-light h5-small">25kg sack of rice</span>
                     
                    </th>

                    <th scope="row">
                    <span><img src="../assets/images/points.png" width="15"></span>
                    <span class="badge h5-small">2500 points</span>           
                   </th>

                    <td class="h5-small"><a href=""><p class="large mb-1">
                      <span data-toggle="modal" data-target="#getVoucher" class="badge alert-info " >4 claims left</span></p></a></td>
                    <td></td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <th scope="row">Goods and Groceries<br/>
                      <span class="badge badge-light h5-small">Groceries worth 2000 pesos</span>
                    ...
                    <td class="h5-small"><a href=""><p class="large mb-1">
                      <span data-toggle="modal" data-target="#getVoucher" class="badge alert-info " >5 claims left</span></p></a></td>
                    <td></td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <th scope="row">Goods and Groceries<br/>
                      <span class="badge badge-light h5-small">Groceries worth 3000 pesos</span>
                     
                    </th>

                    <th scope="row">
                    <span><img src="../assets/images/points.png" width="15"></span>
                    <span class="badge h5-small">6000 points</span>           
                   </th>

                    <td class="h5-small"><a href=""><p class="large mb-1">
                      <span data-toggle="modal" data-target="#getVoucher" class="badge alert-info " >3 claims left</span></p></a></td>
                    <td></td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <th scope="row">Goods and Groceries<br/>
                      <span class="badge badge-light h5-small">Groceries worth 4000 pesos</span>
                     
                    </th>

                    <th scope="row">
                    <span><img src="../assets/images/points.png" width="15"></span>
                    <span class="badge h5-small">7000 points</span>           
                   </th>

                    <td class="h5-small"><a href=""><p class="large mb-1">
                      <span data-toggle="modal" data-target="#getVoucher" class="badge alert-info " >2 claims left</span></p></a></td>
                    <td></td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <th scope="row">Time-off and Leisure<br/>
                      <span class="badge badge-light h5-small">Ticket for two for Jed's Island Resort</span>
                  ...
                  <tr>
                    ...
                    <th scope="row">Time-off and Leisure<br/>
                      <span class="badge badge-light h5-small">1 day 1 night AirBnB @Trees Residences</span>
                     
                    </th>

                    <th scope="row">
                    <span><img src="../assets/images/points.png" width="15"></span>
                    <span class="badge h5-small">8000 points</span>           
                   </th>
                  ...
                  <tr>
                    ...
                    <th scope="row">Home Appliances<br/>
                      <span class="badge badge-light h5-small">Standard Stand Fan</span>
                  ...
                  <tr style="background-color: #f4c430 ;">
                    <td class="text-center">
                      <div class="circle circle-sm bg-light">
                        <span class="ml-1 text-muted"><img src="../assets/images/gift.png" width="25"></span>
                      </div>
                      <span class="dot dot-md bg-danger mr-1"></span>
                    </td>
                    <th scope="row">Home Appliances<br/>
                      <span class="badge badge-light h5-small" style="background-color: #f4c430 ;">Samsung 1HP Inverter Airconditioner</span>
                     
                    </th>

                    <th scope="row">
                    <span><img src="../assets/images/points.png" width="15"></span>
                    <span class="badge h5-small">15000 points</span>           
                   </th>

                    <td class="h5-small"><a href=""><p class="large mb-1">
                      <span data-toggle="modal" data-target="#getVoucher" class="badge alert-info " >1 claim left</span></p></a></td>
                    <td></td>
                  </tr>
