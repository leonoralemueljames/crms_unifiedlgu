...
<html lang="en">
  <head>
    ...
    <title>Data Privacy and Protection for Barangay Employees - CRMS</title>
    ...
    ?>
      ...
      <div class="col">
        <?php
             ...
             echo "<h2 class='h5 page-title'>Data Privacy and Protection for Barangay Employees</h2>";
...
if (ENVIRONMENT === 'local') {
    ...
    $connections = mysqli_connect("localhost", "crms_admin", "+o+fm+K@pI9s5kGy", "crms_system_db");
       ...
       $retrieve_query = mysqli_query($conn, "SELECT * FROM evaluation WHERE employee_name = '$fullname'
        AND course_title='Data Privacy and Protection for Barangay Employees'");
